...
- AI is Gemini 3 Flash via the Google AI Studio API (`@google/genai` SDK with an API key). The user has previous AI app experience and explicitly chose this over Vertex for simpler setup and unified local/prod auth.
